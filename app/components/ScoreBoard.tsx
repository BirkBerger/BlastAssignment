...
function ScoreBoard({ data, onPlayerSelect }: Props) {
    ...
    return (
        <div className="w-full p-4 animate-fadeIn flex flex-col gap-4 rounded-[15]" style={{ backgroundColor: THEME_COLORS[0]}}>
